  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-20 relative bg-[#FAF8F5] pt-8 pb-16 rounded-t-lg">
        ...
        <h1 className="font-serif text-4xl md:text-5xl text-gray-900 mb-4">{name}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 pb-12 border-b border-gray-200">
          <div>
            <p className="text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">Address</p>
            <p className="text-gray-800">{address}</p>
          </div>
          {phone && (
            <div>
              <p className="text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">Phone</p>
              <a href={`tel:${phone.replace(/[^0-9+]/g, '')}`} className="text-gray-800 hover:text-teal-700 transition">
                {phone}
              </a>
            </div>
          )}
        ...
        <div className="mb-12 pb-12 border-b border-gray-200">
          <p className="text-xs tracking-[0.2em] text-gray-500 mb-3">ABOUT THIS LISTING</p>
          <h2 className="font-serif text-2xl text-gray-900 mb-4">Not yet on our platform.</h2>
          <p className="text-gray-600 leading-relaxed">
            This hotel was discovered via Google Maps and is not yet listed on Peshawar Hotel Finder. We're working to add it soon. In the meantime, click below to view more details, photos, and reviews on Google.
          </p>
        </div>

        <div className="mb-12 pb-12 border-b border-gray-200">
          <p className="text-xs tracking-[0.2em] text-gray-500 mb-4">MORE PHOTOS</p>
        ...
        <div className="bg-gradient-to-br from-teal-800 to-teal-600 rounded-2xl p-8 text-white text-center">
          <p className="text-xs tracking-[0.2em] text-teal-100 mb-3 font-medium">READY TO BOOK?</p>
