...
const EditHotel = () => {
    ...
    const fetchHotel = async () => {
      try {
        ...
        setForm({
          ...
          whatsapp: h.whatsapp || "",
          address: h.address || "",
          lat: h.location?.coordinates?.[1]?.toString() || "34.0151",
          lng: h.location?.coordinates?.[0]?.toString() || "71.5249",
          coupleFriendly: h.coupleFriendly || false,
          hasWebsite: h.hasWebsite || false,
  ...
  const removeRoom = (index) => {
    if (rooms.length === 1) {
      alert("At least one room required");
      return;
    }
